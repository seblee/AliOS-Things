...
<<<<<<< HEAD
	cd $(BIN_DIR) && $(SETENV) ESP8266_NM=${NM} && python $(_AOS_PATH)/platform/mcu/esp8266/tools/gen_appbin.py $(CLEANED_BUILD_STRING)$(RADIXPOINT)$(BINSTYPE_LOWER)$(LINK_OUTPUT_SUFFIX) 2 3 15 5 && cd .
=======
	cd $(BIN_DIR) && $(SETENV) ESP8266_NM=${NM} && python $(_AOS_PATH)/platform/mcu/esp8266/tools/gen_appbin.py $(CLEANED_BUILD_STRING)$(RADIXPOINT)$(BINSTYPE_LOWER)$(LINK_OUTPUT_SUFFIX) 2 2 0 5
>>>>>>> master
	$(QUIET) $(CP) $(BIN_DIR)/eagle.app.flash.bin $(BIN_OUTPUT_FILE)
	$(QUIET) $(RM) $(BIN_DIR)/eagle.app.flash.bin $(BIN_DIR)/eagle.app.v6.text.bin $(BIN_DIR)/eagle.app.v6.data.bin $(BIN_DIR)/eagle.app.v6.rodata.bin $(BIN_DIR)/eagle.app.v6.irom0text.bin $(BIN_DIR)/eagle.app.sym
