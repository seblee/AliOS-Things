...
# SEELEDAPP_CONFIG_DEPRECATED ?= n
# SEELEDAPP_CONFIG_PRINT_HEAP ?= n
# SEELEDAPP_CONFIG_COMBOAPP ?= n
...
ifeq ($(SEELEDAPP_CONFIG_CASE_SOLO),y)
ifeq ($(SEELEDAPP_CONFIG_DEPRECATED),y)
...
#case cntdown
ifeq ($(SEELEDAPP_CONFIG_CASE_CNTDOWN),y)
ifeq ($(SEELEDAPP_CONFIG_DEPRECATED),y)
...
#case sched
ifeq ($(SEELEDAPP_CONFIG_CASE_SCHED),y)
ifeq ($(SEELEDAPP_CONFIG_DEPRECATED),y)
...
ifeq ($(SEELEDAPP_CONFIG_COMBOAPP),y)
